    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans selection:bg-indigo-500/30">
            ...
            <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-[20%] right-[20%] w-[30%] h-[30%] bg-blue-500/20 rounded-full blur-[120px] animate-blob animation-delay-4000" />
            </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <Link to="/editor">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="group relative px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl shadow-xl hover:shadow-2xl hover:bg-slate-800 transition-all flex items-center gap-2 overflow-hidden"
                                >
...
const FeatureCard = ({ icon, title, description }) => (
    <motion.div
        whileHover={{ y: -10 }}
        className="p-8 rounded-3xl bg-white/60 border border-white/50 shadow-xl backdrop-blur-md hover:shadow-2xl transition-all"
    >
